<?php $__env->startSection('title', 'Welcome to ROSSA'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero-section text-white py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <h1 class="display-4 fw-bold">Welcome to the Rodent Open Science Skeletal Archive</h1>
                    <p class="lead">Your gateway to advancing skeletal biology research through data sharing,
                        collaboration, and innovation.</p>
                    <p class="fs-5">ROSSA is designed to preserve, share, and connect. Our platform offers researchers and
                        institutions powerful tools to contribute, access, and collaborate in the pursuit of better
                        treatments for skeletal diseases.</p>
                    <div class="mt-4">
                        <a href="#" class="btn btn-primary btn-lg me-3">Join Now</a>
    ...
    <div class="container py-5">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Our streamlined data ingestion system allows researchers to submit skeletal phenotyping data
                            effortlessly. We support various data types and ensure they are standardized and accessible,
                            helping to build a global resource to accelerate discovery in skeletal biology.
                        </p>
                        <p class="card-text text-muted"><strong>Coming Soon:</strong> Detailed guidelines and tools to
                            assist with data preparation and submission.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            We’re developing a robust data center that will revolutionize how researchers interact with
                            skeletal phenotyping data. The future data center will offer powerful tools for search,
                            visualization, and sharing, making it easier than ever to access and utilize groundbreaking
                            datasets.
                        </p>
                        <p class="card-text text-muted"><strong>Stay Tuned:</strong> Exciting features are in development
                            and will be released soon.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            The Core Facility Registry connects researchers with specialized resources. Core facilities can
                            register to showcase their capabilities, and researchers can find the support they need for
                            projects involving imaging, histology, or advanced computational services.
                        </p>
                        <p class="card-text text-muted"><strong>Get Involved:</strong> Whether managing a facility or
                            searching for one, this registry will support your research goals.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-5">
            ...
            <p class="fs-5">ROSSA is more than a database—it’s a community-driven platform built to empower researchers,
                foster collaboration, and drive innovation in skeletal biology.</p>
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-primary btn-lg">Contact Us</a>
        </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ajacob/BoneGPT/resources/views/home.blade.php ENDPATH**/ ?>